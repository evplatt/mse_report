                          ...
                          ARMMMUFaultInfo *fi)
{
    ...
    if (address >= 0x7e000000 && address < 0x7effffff){ //peripheral memory range
      printf("get_phys_addr: 0x%x\n",address);
    }
    if (address >= 0x20000000 && address < 0x20ffffff){ //peripheral memory range
      printf("get_phys_addr: 0x%x\n",address);
    }
